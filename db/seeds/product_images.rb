...
IMAGE_URLS = [
  ...
  "/66485/methodanc.vinylsaigon11-450x450-c.webp",
  "/66246/540active.vinylsaigon3-450x450-c.webp",
  "/66238/hd620s.vinylsaigon3-450x450-c.webp",
  "/65768/RU9.vinylsaigon3-450x450-c.webp",
...
IMAGE_URLS.each_with_index do |image_url, index|
  ...
  begin
    File.open(image_path, 'wb') do |f|
      f.write(URI.open(
        "https://vinylsaigon.vn/wp-content/uploads/fly-images#{image_url}",
