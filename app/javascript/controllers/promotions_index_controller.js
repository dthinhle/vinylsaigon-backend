...
export default class extends BulkActionsController {
  static targets = [...BulkActionsController.targets, "moreFilters", "moreFiltersToggle", "search"]
  ...
  getDefaultDeleteUrl() {
    return '/admin/promotions/destroy_selected'
  }

  getConfirmMessage() {
    return "Are you sure you want to delete the selected promotions? This action cannot be undone."
  }
