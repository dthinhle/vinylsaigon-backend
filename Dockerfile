...
# docker build -t vinylsaigon_backend .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name vinylsaigon_backend vinylsaigon_backend
...
# Use Corepack to run Yarn (supports v4+)
